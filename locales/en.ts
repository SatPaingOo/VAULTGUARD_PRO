...
export default {
  ...
  "apikey": {
    ...
    "go_enable_gen_lang": "Go to Google Cloud Console → APIs & Services → Library → Search \"Generative Language API\" → Enable",
    ...
    "step3_title": "3. Search Grounding Feature",
    "step3_desc": "Enable Google Search Grounding in your Google Cloud Project. Required for live CVE database cross-referencing.",
    ...
    "error_missing_models_suggestions": ["Enable Generative Language API in Google Cloud Console", "Go to: https://console.cloud.google.com/apis/library", "Search for \"Generative Language API\" and enable it"],
