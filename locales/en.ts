...
export default {
  ...
  "cors_extension": {
    ...
    "extension_on_then_what": "Turning the extension ON alone is not enough. You must reload this page, then run a new scan. Otherwise the next scan may still show Blocked.",
    "how_to_step1": "Install the extension from the link below (Chrome Web Store or Firefox Add-ons).",
    "how_to_step2": "Turn the extension ON: Click the extension icon in your toolbar and toggle it ON (icon turns orange).",
    "how_to_step3": "Whitelist this site if your extension has a whitelist: add the VaultGuard URL (e.g. localhost:3000 or your deployed URL) so the extension runs on this page.",
    "how_to_step4": "Reload this page (F5 or Ctrl+R). This is required so the extension applies to the next requests.",
    "how_to_step5": "Run a new scan. If you had a previous scan that was Blocked, wait 1–2 minutes or reload again so cached results expire.",
    "how_to_step6": "After the scan finishes, turn the extension OFF for security.",
